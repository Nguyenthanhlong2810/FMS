...
public class StandardRemoteSchedulerService
  ...
  @Override
  public void updateMailingSchedulerTask(ClientID clientId) {
    userManager.verifyCredentials(clientId, UserPermission.MODIFY_DATELOG);

    schedulerService.updateMailingSchedulerTask();
  }
}
