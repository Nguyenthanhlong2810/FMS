...
public class StandardRemoteNotificationService
  ...
  @Override
  public boolean sendReportMail(ClientID clientID, String[] receipts, Date from, Date to) {
      return notificationService.sendReportMail(receipts, from, to);
  }

  @Override
  public void changePassword(ClientID clientID, String oldPassword, String newPassword) {
    userManager.changePassword(clientID, oldPassword, newPassword);
  }
}
