...
public class StandardRemoteVehicleService
  ...
  @Override
  public Vehicle createVehicle(ClientID clientID, Vehicle vehicle) throws RemoteException {
    userManager.verifyCredentials(clientID, UserPermission.MODIFY_VEHICLES);
    try {
      return kernelExecutor.submit(() -> vehicleService.createVehicle(vehicle)).get();
    }
    catch (InterruptedException | ExecutionException | ValidateException exc) {
      throw findSuitableExceptionFor(exc);
    }
  }

  @Override
  public Vehicle updateVehicle(ClientID clientID, Vehicle vehicle) throws RemoteException {
    userManager.verifyCredentials(clientID, UserPermission.MODIFY_VEHICLES);
    try {
      return kernelExecutor.submit(() -> vehicleService.updateVehicle(vehicle)).get();
    }
    catch (InterruptedException | ExecutionException | ValidateException exc) {
      throw findSuitableExceptionFor(exc);
    }
  ...
  @Override
  public Vehicle removeVehicle(ClientID clientID, Vehicle vehicle) throws RemoteException {
    userManager.verifyCredentials(clientID, UserPermission.MODIFY_VEHICLES);
    try {
      return kernelExecutor.submit(() -> vehicleService.removeVehicle(vehicle)).get();
    }
  ...
  @Override
  public void updateVehicleErrorCode(ClientID clientId, TCSObjectReference<Vehicle> ref, int errorCode)
          throws RemoteException {
    try {
      kernelExecutor.submit(
              () -> vehicleService.updateVehicleErrorCode(ref, errorCode))
              .get();
    }
    catch (InterruptedException | ExecutionException exc) {
      throw findSuitableExceptionFor(exc);
  ...
  @Override
  public void updateVehicleVoltage(ClientID clientId, TCSObjectReference<Vehicle> ref, float voltage)
          throws RemoteException {
    try {
      kernelExecutor.submit(
              () -> vehicleService.updateVehicleVoltage(ref, voltage))
              .get();
    }
    catch (InterruptedException | ExecutionException exc) {
      throw findSuitableExceptionFor(exc);
  ...
  @Override
  public void updateVehicleCurrent(ClientID clientId, TCSObjectReference<Vehicle> ref, float current)
          throws RemoteException {
    try {
      kernelExecutor.submit(
              () -> vehicleService.updateVehicleCurrent(ref, current))
              .get();
    }
    catch (InterruptedException | ExecutionException exc) {
      throw findSuitableExceptionFor(exc);
  ...
  @Override
  public void updateVehicleWarningState(ClientID clientId, TCSObjectReference<Vehicle> ref, boolean warning)
          throws RemoteException {
    try {
      kernelExecutor.submit(
              () -> vehicleService.updateVehicleWarningState(ref, warning))
              .get();
    }
    catch (InterruptedException | ExecutionException exc) {
      throw findSuitableExceptionFor(exc);
