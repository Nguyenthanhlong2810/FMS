...
import org.opentcs.kernel.services.*;
...
import org.opentcs.kernel.workingset.*;
...
public class DefaultKernelInjectionModule
  ...
  private void configureDatabase() {
    bind(HibernateConfiguration.class).toInstance(getConfigBindingProvider()
            .get(HibernateConfiguration.PREFIX, HibernateConfiguration.class));
