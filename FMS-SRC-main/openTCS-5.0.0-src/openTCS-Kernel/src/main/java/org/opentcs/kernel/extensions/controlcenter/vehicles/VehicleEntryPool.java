...
public class VehicleEntryPool
  ...
  public void initialize() {
    ...
    objectService.fetchObjects(Vehicle.class).stream()
        .forEach(vehicle -> createVehicleEntry(vehicle));
  ...
  public VehicleEntry createVehicleEntry(Vehicle vehicle) {
    VehicleEntry vehicleEntry = new VehicleEntry(vehicle);
    entries.put(vehicle.getName(), vehicleEntry);
