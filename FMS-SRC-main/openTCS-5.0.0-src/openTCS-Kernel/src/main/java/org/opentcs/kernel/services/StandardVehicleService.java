...
public class StandardVehicleService
  ...
  public void updateVehicleNextPositionWhenLoop(TCSObjectReference<Vehicle> vehicleRef,
                                                String pointRef)
          throws ObjectUnknownException {
    synchronized (globalSyncObject) {
      model.setVehicleNextPositionWhenLoop(vehicleRef, pointRef);
    }
  }
  ...
  public void updateVehiclePrecisePositionByDistance(TCSObjectReference<Vehicle> ref, double distance)
          throws ObjectUnknownException {
    synchronized (globalSyncObject) {
      model.setVehiclePrecisePositionByDistance(ref, distance);
    }
  }
  ...
  public Vehicle createVehicle(Vehicle vehicle)
          throws ObjectUnknownException, ValidateException {
    synchronized (globalSyncObject) {
      attachmentManager.tryValidateVehicleCommInfo(vehicle);
      Vehicle createdVehicle = model.createVehicle(vehicle);
      attachmentManager.createVehicleEntry(createdVehicle);
   ...
   *
   * @param vehicle vehicle entity in database
   * @return updated vehicle.
   */
  @Override
  public Vehicle updateVehicle(Vehicle vehicle) throws ObjectUnknownException, ValidateException {
    synchronized (globalSyncObject) {
      attachmentManager.tryValidateVehicleCommInfo(vehicle);
      model.updateVehicle(vehicle);
      attachmentManager.updateVehicleEntry(vehicle);
      return vehicle;
    }
  }
   ...
   */
  @Override
  public Vehicle removeVehicle(Vehicle vehicle) throws ObjectUnknownException {
    synchronized (globalSyncObject) {
      attachmentManager.removeVehicleEntry(vehicle);
      return model.removeVehicle(vehicle);
    }
  }
  ...
  @Override
  public void updateVehicleErrorCode(TCSObjectReference<Vehicle> ref,
                                     int errorCode)
          throws ObjectUnknownException {
    synchronized (globalSyncObject) {
      model.setVehicleErrorCode(ref, errorCode);
    }
  }

  public void updateVehicleErrorMessages(TCSObjectReference<Vehicle> ref,
                                         HashMap<String, String> errorMessages)
          throws ObjectUnknownException {
    synchronized (globalSyncObject) {
      model.setVehicleErrorMessages(ref, errorMessages);
    }
  }

  @Override
  public void updateVehicleVoltage(TCSObjectReference<Vehicle> ref,
                                             float voltage)
          throws ObjectUnknownException {
    synchronized (globalSyncObject) {
      model.setVehicleVoltage(ref, voltage);
    }
  }

  @Override
  public void updateVehicleCurrent(TCSObjectReference<Vehicle> ref,
                                   float current)
          throws ObjectUnknownException {
    synchronized (globalSyncObject) {
      model.setVehicleCurrent(ref, current);
    }
  }

  @Override
  public void updateVehicleWarningState (TCSObjectReference<Vehicle> ref,
                                         boolean warning)
    throws ObjectUnknownException  {
    synchronized (globalSyncObject) {
      model.setVehicleWarningState(ref, warning);
    }
  }

  public Vehicle updateVehicleCurrentRoute(TCSObjectReference<Vehicle> ref,
                                        WorkingRoute.WorkingRouteRaw workingRoute)
    throws ObjectUnknownException {
    synchronized (globalSyncObject) {
      return model.setVehicleCurrentRoute(ref, workingRoute);
    }
  }
}
