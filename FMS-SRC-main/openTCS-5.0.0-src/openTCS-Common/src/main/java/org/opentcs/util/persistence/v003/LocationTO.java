...
@XmlType(propOrder = {"name", "xPosition", "yPosition", "zPosition", "links", "properties", "width", "height"})
public class LocationTO
  ...
  public LocationTO setWidth(@Nonnull Long width) {
  ...
  public LocationTO setHeight(@Nonnull Long height) {
    requireNonNull(height, "height");
    this.height = height;
    return this;
  }
