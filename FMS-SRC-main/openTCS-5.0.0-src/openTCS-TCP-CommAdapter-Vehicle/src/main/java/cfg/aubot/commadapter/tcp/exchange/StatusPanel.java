...
import cfg.aubot.commadapter.tcp.exchange.commands.SetPeriodicStateRequestEnabledCommand;
import cfg.aubot.commadapter.tcp.exchange.commands.SetStateRequestIntervalCommand;
...
public class StatusPanel
  ...
  private static final ResourceBundle resourceBundle
      = ResourceBundle.getBundle("cfg/aubot/commadapter/tcp/Bundle");
  /**
  ...
  private void updateStatusPanel(final StateResponse state) {
    ...
    textFieldCurrent.setText(String.format("%4.2f", state.getCurrent()));
    textFieldVoltage.setText(String.format("%4.2f", state.getVoltage()));
  }
  ...
  private void initComponents() {
    ...
    textFieldCurrent = new javax.swing.JTextField();
    lableVoltage = new javax.swing.JLabel();
    textFieldVoltage = new javax.swing.JTextField();
    labelCurrent = new javax.swing.JLabel();
    fillingLabel1 = new javax.swing.JLabel();

    setLayout(new java.awt.GridBagLayout());

    ResourceBundle bundle = ResourceBundle.getBundle("cfg/aubot/commadapter/tcp/Bundle"); // NOI18N
    ...
    textFieldCurrent.setBackground(new java.awt.Color(255, 255, 204));
    textFieldCurrent.setFont(new java.awt.Font("Monospaced", 0, 11)); // NOI18N
    textFieldCurrent.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
    textFieldCurrent.setText("aa");
    textFieldCurrent.setPreferredSize(new java.awt.Dimension(62, 22));
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 3;
    gridBagConstraints.gridy = 0;
    gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
    gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
    gridBagConstraints.insets = new java.awt.Insets(0, 0, 3, 0);
    panelTelegramContent.add(textFieldCurrent, gridBagConstraints);

    lableVoltage.setText("Voltage:");
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 4;
    gridBagConstraints.gridy = 0;
    gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
    gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 3);
    panelTelegramContent.add(lableVoltage, gridBagConstraints);

    textFieldVoltage.setEditable(false);
    textFieldVoltage.setBackground(new java.awt.Color(255, 255, 204));
    textFieldVoltage.setFont(new java.awt.Font("Monospaced", 0, 11)); // NOI18N
    textFieldVoltage.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
    textFieldVoltage.setText("12VVVVVV");
    textFieldVoltage.setPreferredSize(new java.awt.Dimension(55, 22));
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 5;
    gridBagConstraints.gridy = 0;
    gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
    panelTelegramContent.add(textFieldVoltage, gridBagConstraints);
    ...
    gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
    gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 3);
    panelTelegramContent.add(labelCurrent, gridBagConstraints);
  ...
  private javax.swing.JLabel lableVoltage;
  ...
  private javax.swing.JTextField textFieldCurrent;
  ...
  private javax.swing.JTextField textFieldVoltage;
