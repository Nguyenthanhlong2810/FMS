...
import cfg.aubot.commadapter.tcp.ExampleProcessModel;
import cfg.aubot.commadapter.tcp.exchange.commands.*;
import cfg.aubot.commadapter.tcp.telegrams.MovingRequest;
...
public class ControlPanel
   ...
   *
   */
  private final ImageIcon GREEN_CIRCLE_ICON = new ImageIcon(getClass().getResource("/cfg/aubot/commadapter/tcp/res/symbols/icons8_Green_Circle_48px.png"));

  private final ImageIcon RED_CIRCLE_ICON = new ImageIcon(getClass().getResource("/cfg/aubot/commadapter/tcp/res/symbols/icons8_Red_Circle_48px.png"));

  private final ImageIcon GREEN_CIRCLE__PRESSED_ICON = new ImageIcon(getClass().getResource("/cfg/aubot/commadapter/tcp/res/symbols/icons8_Green_Circle_pressed_48px.png"));

  private final ImageIcon RED_CIRCLE_PRESSED_ICON = new ImageIcon(getClass().getResource("/cfg/aubot/commadapter/tcp/res/symbols/icons8_Red_Circle_pressed_48px.png"));
  ...
  private void initGuiContent() {
    ...
    repeatOrderPanel.setVisible(false);
  }
  ...
  private void initComponents() {
    ...
    java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("cfg/aubot/commadapter/tcp/Bundle"); // NOI18N
    ...
    connectedButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cfg/aubot/commadapter/tcp/res/symbols/LEDGray.gif"))); // NOI18N
    connectedButton.setText(bundle.getString("AdapterConnected")); // NOI18N
    connectedButton.setBorderPainted(false);
    connectedButton.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/cfg/aubot/commadapter/tcp/res/symbols/LEDRed.gif"))); // NOI18N
    connectedButton.setDisabledSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/cfg/aubot/commadapter/tcp/res/symbols/LEDGreen.gif"))); // NOI18N
  ...
  activeButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cfg/aubot/commadapter/tcp/res/symbols/LEDGray.gif"))); // NOI18N
  activeButton.setText(bundle.getString("ControlPanel.AdapterActive")); // NOI18N
  activeButton.setBorderPainted(false);
  activeButton.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/cfg/aubot/commadapter/tcp/res/symbols/LEDRed.gif"))); // NOI18N
  activeButton.setDisabledSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/cfg/aubot/commadapter/tcp/res/symbols/LEDGreen.gif"))); // NOI18N
  ...
  btnMove.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cfg/aubot/commadapter/tcp/res/symbols/icons8_Green_Circle_48px.png"))); // NOI18N
  btnMove.addMouseListener(new java.awt.event.MouseAdapter() {
    public void mousePressed(java.awt.event.MouseEvent evt) {
      btnMoveMousePressed(evt);
    }
    public void mouseReleased(java.awt.event.MouseEvent evt) {
      btnMoveMouseReleased(evt);
    }
  });
  gridBagConstraints = new java.awt.GridBagConstraints();
  ...
  connectionSettingsPanel.add(btnMove, gridBagConstraints);

  btnStop.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
  btnStop.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cfg/aubot/commadapter/tcp/res/symbols/icons8_Red_Circle_48px.png"))); // NOI18N
  ...
  gridBagConstraints.gridheight = 2;
  gridBagConstraints.weightx = 0.2;
  connectionSettingsPanel.add(btnStop, gridBagConstraints);
  ...
  private void enableAdapterCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enableAdapterCheckBoxActionPerformed
    this.vehicleService.fetchObjects(Vehicle.class);
    for(Vehicle vehicle : this.vehicleService.fetchObjects(Vehicle.class)){
      vehicle.getProperty(PROPKEY_VEHICLE_HOST);
    }
  ...
  private void btnMoveMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnMoveMousePressed
    btnMove.setIcon(GREEN_CIRCLE__PRESSED_ICON);
    sendAdapterCommand(new SendRequestCommand(new MovingRequest(Telegram.ID_DEFAULT, MoveState.MOVE)));
  ...
  private void btnStopMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnStopMousePressed
    btnStop.setIcon(RED_CIRCLE_PRESSED_ICON);
    sendAdapterCommand(new SendRequestCommand(new MovingRequest(Telegram.ID_DEFAULT, MoveState.STOP)));
  }//GEN-LAST:event_btnStopMousePressed

  private void btnMoveMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnMoveMouseReleased
    btnMove.setIcon(GREEN_CIRCLE_ICON);
  }//GEN-LAST:event_btnMoveMouseReleased

  private void btnStopMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnStopMouseReleased
    btnStop.setIcon(RED_CIRCLE_ICON);
