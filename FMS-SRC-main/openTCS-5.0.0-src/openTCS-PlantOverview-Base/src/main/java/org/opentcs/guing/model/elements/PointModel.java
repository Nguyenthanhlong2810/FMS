...
public class PointModel
  ...
  @SuppressWarnings("unchecked")
  public SelectionPointProperty<String> getLeftPoint() {
    return (SelectionPointProperty<String>) getProperty(LEFT_POINT);
  }

  public SelectionPointProperty<String> getRightPoint() {
    return (SelectionPointProperty<String>) getProperty(RIGHT_POINT);
  }
  ...
  private void createProperties() {
    ...
    PointProperty pLeftPoint = new PointProperty(this);
    pLeftPoint.setDescription(bundle.getString("pointModel.property_leftPoint.description"));
    pLeftPoint.setHelptext(bundle.getString("pointModel.property_leftPoint.helptext"));
    pType.setCollectiveEditable(true);
    setProperty(LEFT_POINT, pLeftPoint);

    PointProperty pRightPoint = new PointProperty(this);
    pRightPoint.setDescription(bundle.getString("pointModel.property_rightPoint.description"));
    pRightPoint.setHelptext(bundle.getString("pointModel.property_rightPoint.helptext"));
    pType.setCollectiveEditable(true);
    setProperty(RIGHT_POINT, pRightPoint);
