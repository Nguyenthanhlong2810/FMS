...
import org.opentcs.guing.plugins.themes.AubotVehicleTheme;
...
public class VehicleModel
  ...
  public static final String VEHICLE_VOLTAGE = "Voltage";
  public static final String VEHICLE_CURRENT = "Current";
  /**
  ...
  /**
   * Vehicle's type theme
   * customized by Khoi - AUBOT
   */
  private AubotVehicleTheme vehicleTheme = new AubotVehicleTheme();
  /**
   * Vehicle's voltage
   * customized by Khoi - AUBOT
   */
  ...
  public StringProperty getPropertyTypeTheme() {
    return (StringProperty) getProperty(ElementPropKeys.VEHICLE_TYPE_THEME);
  }

  public FloatProperty getPropertyVoltage() { return (FloatProperty) getProperty(VEHICLE_VOLTAGE); }

  public FloatProperty getPropertyCurrent() { return (FloatProperty) getProperty(VEHICLE_CURRENT); }
  ...
  private void createProperties() {
    ...
    StringProperty pTypeTheme = new StringProperty(this, "Default");
    pTypeTheme.setDescription(bundle.getString("vehicleModel.property_typeTheme.description"));
    pTypeTheme.setHelptext(bundle.getString("vehicleModel.property_typeTheme.helptext"));
    setProperty(ElementPropKeys.VEHICLE_TYPE_THEME, pTypeTheme);
...
//    setProperty(MAXIMUM_REVERSE_VELOCITY, pMaximumReverseVelocity);
    ...
    FloatProperty pVoltage = new FloatProperty(this);
    pVoltage.setDescription(bundle.getString("vehicleModel.property_voltage.description"));
    pVoltage.setHelptext(bundle.getString("vehicleModel.property_voltage.helptext"));
    pVoltage.setModellingEditable(false);
    setProperty(VEHICLE_VOLTAGE, pVoltage);

    FloatProperty pCurrent = new FloatProperty(this);
    pCurrent.setDescription(bundle.getString("vehicleModel.property_current.description"));
    pCurrent.setHelptext(bundle.getString("vehicleModel.property_current.helptext"));
    pCurrent.setModellingEditable(false);
    setProperty(VEHICLE_CURRENT, pCurrent);
    ...
    SelectionProperty<Vehicle.State> pState
        = new VehicleStateSelectionProperty(this);
...
//    setProperty(ALLOWED_ORDER_TYPES, pAllowedOrderTypes);
  ...
  public Image getStateImage() {
    return vehicleTheme.getImage(vehicle);
  }

  public AubotVehicleTheme getVehicleTheme() {
    return vehicleTheme;
  }
}
