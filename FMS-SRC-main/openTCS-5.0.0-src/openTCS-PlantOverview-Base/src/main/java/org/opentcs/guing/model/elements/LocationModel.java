...
public class LocationModel
  ...
  public LengthProperty getWidthProperty(){
    return (LengthProperty) getProperty(ElementPropKeys.WIDTH);
  }


  public LengthProperty getHeightProperty(){
    return (LengthProperty) getProperty(ElementPropKeys.HEIGHT);
  }
  ...
  private void createProperties() {
    ...
    LengthProperty pWidth =  new LengthProperty(this);
    pWidth.setDescription("locationModel.property_width.description");
    pWidth.setHelptext("locationModel.property_width.helptext");
    setProperty(ElementPropKeys.WIDTH,pWidth);

    LengthProperty pHeight =  new LengthProperty(this);
    pHeight.setDescription("locationModel.property_height.description");
    pHeight.setHelptext("locationModel.property_height.helptext");
    setProperty(ElementPropKeys.HEIGHT, pHeight);
