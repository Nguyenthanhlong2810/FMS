...
public abstract class PlantOverviewInjectionModule
  ...
  /**
   * Returns a multibinder that can be used to register classes for validate vehicles communication information.
   *
   * @return The multibinder.
   */
  protected Multibinder<VehicleCommInfoValidator> vehicleCommInfoValidatorBinder() {
    return Multibinder.newSetBinder(binder(), VehicleCommInfoValidator.class);
  }

  protected Multibinder<VehicleCommunicationInfoPanelFactory> vehicleCommunicationInfoPanelFactoryBinder() {
    return Multibinder.newSetBinder(binder(), VehicleCommunicationInfoPanelFactory.class);
  }
}
