...
public class ContinuousLoadPanel
  ...
  private OrderGenerationTrigger createOrderGenTrigger() {
    ...
    else if (loopTriggerRadioButton.isSelected()) {
      return new InfinityOrderGenTrigger(eventSource, (ExplicitOrderBatchGenerator) batchCreator);
    }
    else {
   ...
   */
    ...
    private void initComponents() {
        ...
        loopTriggerRadioButton = new javax.swing.JRadioButton();
        ...
        triggerButtonGroup.add(loopTriggerRadioButton);
        loopTriggerRadioButton.setText("Loop on vehicles individually");
        loopTriggerRadioButton.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                loopTriggerRadioButtonItemStateChanged(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        triggerPanel.add(loopTriggerRadioButton, gridBagConstraints);
  ...
  private void loopTriggerRadioButtonItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_loopTriggerRadioButtonItemStateChanged
    if (evt.getStateChange() == ItemEvent.SELECTED) {
      randomOrderSpecButton.setEnabled(false);
      explicitOrderSpecButton.setSelected(true);
      updateElementStates();
    }
    else {
      randomOrderSpecButton.setEnabled(true);
    }
  }//GEN-LAST:event_loopTriggerRadioButtonItemStateChanged
    ...
    private javax.swing.JRadioButton loopTriggerRadioButton;
