...
public class PointCreationTO
  ...
  private String leftPoint = null;

  private String rightPoint = null;
  ...
  private PointCreationTO(@Nonnull String name,
                          ...
                          String leftPoint,String rightPoint) {
  ...
  public PointCreationTO withLeftPoint(String leftPoint){
  ...
  public PointCreationTO withRightPoint(String rightPoint){
    return new PointCreationTO(getName(),
            getProperties(),
            position,
            vehicleOrientationAngle,
  ...
  public PointCreationTO withProperties(@Nonnull Map<String, String> properties) {
    return new PointCreationTO(getName(), properties, position, vehicleOrientationAngle, type,leftPoint,rightPoint);
  }
