...
public interface VehicleService
   ...
   */
  Vehicle createVehicle(Vehicle vehicle) throws ValidateException;
  /**
   ...
   */
  Vehicle updateVehicle(Vehicle vehicle) throws ValidateException;
  /**
  ...
  void updateVehicleErrorCode(TCSObjectReference<Vehicle> ref,
                              int errorCode)
      throws ObjectUnknownException, KernelRuntimeException;

  void updateVehicleVoltage(TCSObjectReference<Vehicle> ref,
                                   float voltage)
      throws ObjectUnknownException, KernelRuntimeException;

  void updateVehicleCurrent(TCSObjectReference<Vehicle> ref,
                                   float current)
      throws ObjectUnknownException, KernelRuntimeException;

  void updateVehicleWarningState (TCSObjectReference<Vehicle> ref,
                                         boolean warning)
      throws ObjectUnknownException, KernelRuntimeException;
}
