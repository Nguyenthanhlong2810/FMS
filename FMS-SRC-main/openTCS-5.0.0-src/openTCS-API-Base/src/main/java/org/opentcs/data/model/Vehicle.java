...
public class Vehicle
  ...
  /**
   * Attribute for vehicle type theme
   * customized by Khoi - AUBOT
   */
  private String typeTheme;
  /**
   * Attribute for vehicle error code
   * error code was organized in database
   * customized by Khoi - AUBOT
   */
  ...
  /**
   * Electric current  of vehicle
   */
  private float current;

  private int color;
  /**
   * Warning state of vehicle
   */
  private boolean warning;
  /**
   * Current working route of vehicle
   */
  private WorkingRoute workingRoute;
  /**
  ...
  public Vehicle(String name) {
    ...
    this.typeTheme = "Default";
    this.errorCode = 0;
    this.voltage = 0;
    this.current = 0;
    this.warning = false;
    this.errorMessages = new HashMap<>();
    this.workingRoute = new WorkingRoute(0);
    this.color = 0;
  }
  ...
  private Vehicle(String name,
                  ...
                  String typeTheme, int errorCode, HashMap<String, String> errorMessages,
                  float voltage, float current, boolean warning, WorkingRoute workingRoute, int color) {
  ...
  public Vehicle withProperty(String key, String value) {
    return new Vehicle(getName(),
                       ...
                       energyLevel,
                       loadHandlingDevices,
                       typeTheme, errorCode, errorMessages,
                       voltage, current, warning, workingRoute, color);
  }
  ...
  public Vehicle withTypeTheme(String typeTheme) {
    return new Vehicle(getName(),
            getProperties(),
            getHistory(),
            length,
  ...
  public Vehicle withErrorCode(int errorCode) {
    return new Vehicle(getName(),
            getProperties(),
            getHistory(),
            length,
  ...
  public HashMap<String, String> getErrorMessages() { return this.errorMessages; }

  public Vehicle withErrorMessages(HashMap<String, String> errorMessages) {
    return new Vehicle(getName(),
            getProperties(),
            getHistory(),
            length,
  ...
  public Vehicle withVoltage(float voltage) {
    return new Vehicle(getName(),
            getProperties(),
            getHistory(),
            length,
  ...
  public Vehicle withCurrent(float current) {
    return new Vehicle(getName(),
            getProperties(),
            getHistory(),
            length,
  ...
  public Vehicle withWarning(boolean warning) {
    return new Vehicle(getName(),
            getProperties(),
            getHistory(),
            length,
  ...
  public WorkingRoute getWorkingRoute() {
    return workingRoute;
  }

  public Vehicle withWorkingRoute(WorkingRoute workingRoute) {
    return new Vehicle(getName(),
            getProperties(),
            getHistory(),
            length,
  ...
  public Vehicle withColor(int color) {
    return new Vehicle(getName(),
            getProperties(),
            getHistory(),
            length,
