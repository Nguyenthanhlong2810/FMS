...
public class VehicleProcessModelTO
  ...
  public VehicleProcessModelTO setWarning(boolean warning) {
  ...
  public VehicleProcessModelTO setVoltage(float voltage) {
  ...
  public VehicleProcessModelTO setCurrent(float current) {
  ...
  public VehicleProcessModelTO setErrorCode(int errorCode) {
  ...
  public VehicleProcessModelTO setWorkingRoute(WorkingRoute.WorkingRouteRaw workingRoute) {
