...
public interface RemoteVehicleService
  ...
  Vehicle createVehicle(ClientID clientID, Vehicle vehicle) throws RemoteException;

  Vehicle updateVehicle(ClientID clientID, Vehicle vehicle) throws RemoteException;

  Vehicle removeVehicle(ClientID clientID, Vehicle vehicle) throws RemoteException;
  ...
  void updateVehicleErrorCode(ClientID clientId,
                                      TCSObjectReference<Vehicle> ref,
                                      int errorCode)
          throws RemoteException;

  void updateVehicleVoltage(ClientID clientId,
                              TCSObjectReference<Vehicle> ref,
                              float voltage)
          throws RemoteException;

  void updateVehicleCurrent(ClientID clientId,
                              TCSObjectReference<Vehicle> ref,
                              float current)
          throws RemoteException;

  void updateVehicleWarningState(ClientID clientId,
                              TCSObjectReference<Vehicle> ref,
                              boolean warning)
          throws RemoteException;
}
