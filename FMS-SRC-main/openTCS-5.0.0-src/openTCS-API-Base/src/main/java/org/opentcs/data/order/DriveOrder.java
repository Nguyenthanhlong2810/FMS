...
public class DriveOrder
  ...
  private int currentCountOnSteps = 0;
  /**
   * add new row
   */
  ...
  private DriveOrder(@Nonnull Destination destination,
                     ...
                     @Nonnull State state, int currentCountOnSteps) {
    this.destination = requireNonNull(destination, "destination");
    this.transportOrder = transportOrder;
    this.route = route;
    this.state = requireNonNull(state, "state");
    this.currentCountOnSteps = currentCountOnSteps;
  }
  ...
  public DriveOrder withTransportOrder(
      @Nullable TCSObjectReference<TransportOrder> transportOrder) {
    return new DriveOrder(destination, transportOrder, route, state, currentCountOnSteps);
  }
  ...
  public void setCurrentCountOnSteps(int currentCountOnSteps) {
    this.currentCountOnSteps = currentCountOnSteps;
  }

  public int getCurrentCountOnSteps() {
    return currentCountOnSteps;
  }

  public int decreaseLoopCount() {
    return currentCountOnSteps--;
  }
}
