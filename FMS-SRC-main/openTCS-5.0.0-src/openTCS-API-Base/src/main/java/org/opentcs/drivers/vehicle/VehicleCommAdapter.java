...
public interface VehicleCommAdapter
  ...
  /**
   * Send vehicle routes for bus mode
   * @param mapId model unique
   * @param routes list of routes
   */
  void sendVehicleRoutes(int mapId, Map<Integer, Route> routes);

  void askVehicleCurrentRoute(int mapId);

  void setVehicleCurrentRoute(WorkingRoute.WorkingRouteRaw workingRoute);
}
