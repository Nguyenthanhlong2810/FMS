...
public class LocationCreationTO
  ...
  public LocationCreationTO withName(@Nonnull String name) {
    return new LocationCreationTO(name, getModifiableProperties(), typeName, position, links,width,height);
  }
  ...
  public LocationCreationTO withTypeName(@Nonnull String typeName) {
    return new LocationCreationTO(getName(), getModifiableProperties(), typeName, position, links, width, height);
  }
  ...
  public LocationCreationTO withWidth(@Nonnull Long width) {
    return new LocationCreationTO(getName(), getModifiableProperties(), typeName, position, links, width, height);
  }
  ...
  public LocationCreationTO widthHeight(@Nonnull Long height) {
    return new LocationCreationTO(getName(), getModifiableProperties(), typeName, position, links, width, height);
  }
  ...
  public LocationCreationTO withLink(@Nonnull String pointName,
    ...
    return new LocationCreationTO(getName(),
                                  ...
                                  typeName,
                                  position,
                                  mapWithMapping(links, pointName, allowedOperations), width, height);
  }
  ...
  public LocationCreationTO withProperties(@Nonnull Map<String, String> properties) {
    return new LocationCreationTO(getName(), properties, typeName, position, links, width, height);
  }
  ...
  public LocationCreationTO withProperty(@Nonnull String key, @Nonnull String value) {
    return new LocationCreationTO(getName(), propertiesWith(key, value), typeName, position, links, width, height);
  }
}
