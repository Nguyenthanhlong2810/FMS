...
public abstract class BasicVehicleCommAdapter
  ...
  public VehicleProcessModelTO createTransferableProcessModel() {
    return createCustomTransferableProcessModel()
        ...
        .setErrorCode(getProcessModel().getErrorCode())
        .setVoltage(getProcessModel().getVehicleVoltage())
        .setCurrent(getProcessModel().getVehicleCurrent())
        .setWarning(getProcessModel().isWarning())
        .setWorkingRoute(getProcessModel().getWorkingRoute());
  }
