...
public class VehicleCreationTO
  ...
  private String typeTheme = "Default";
  ...
  private VehicleCreationTO(@Nonnull String name,
                            ...
                            int maxVelocity,
                            int maxReverseVelocity, String typeTheme,int color) {
  ...
  public VehicleCreationTO withName(@Nonnull String name) {
    return new VehicleCreationTO(name,
                                 ...
                                 maxVelocity,
                                 maxReverseVelocity, typeTheme,color);
  }
   ...
   */
  public VehicleCreationTO withColor(int color) {
    return new VehicleCreationTO(getName(),
            getModifiableProperties(),
            length,
            energyLevelCritical,
  ...
  public VehicleCreationTO withTypeTheme(String typeTheme) {
    checkInRange(maxReverseVelocity, 0, Integer.MAX_VALUE);
    return new VehicleCreationTO(getName(),
            getModifiableProperties(),
            length,
