...
public class DefaultServiceCallWrapper
   ...
   */
  @Inject
  public DefaultServiceCallWrapper(PortalManager portalManager) {
  ...
  private boolean showRetryDialog() {
    ...
    if (dialogSelection == JOptionPane.YES_OPTION) {// Only retry if we connected successfully
      return portalManager.connect(0);
    }
    return false;
  }
}
