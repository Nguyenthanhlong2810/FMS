...
public class PathConnection
  ...
  public static final AttributeKey<Color> HIGHLIGHT_COLOR = new AttributeKey<>("highlightRouteColor", Color.class, new Color (0, 0, 0, 0), true);
  public final static AttributeKey<java.lang.Double> HIGHLIGHT_STROKE_WIDTH = new AttributeKey<>("highlightRouteStrokeWidth", java.lang.Double.class, 0d, false);
  /**
   * This class's logger.
   */
  ...
  public LengthProperty calculateLength() {
    try {
    ...
    List<Handle> handles = new LinkedList<>();
      ...
      switch (detailLevel % 2) {
        ...
        case 0:  // Mouse clicked
          handles.add(new BezierOutlineHandle(this, true));
          if (this.applicationState.getOperationMode().equals(OperationMode.MODELLING)) {
            if (getLinerType() == PathModel.Type.POLYPATH) {
              for (int i = 1; i < path.size() - 1; i++) {
...
//          TransformHandleKit.addTransformHandles(this, handles);
  ...
  public void setColorGroup(Color routeColor, double strokeWidth) {
    set(HIGHLIGHT_COLOR, routeColor);
    set(HIGHLIGHT_STROKE_WIDTH, strokeWidth);
  }

  public void setDefaultStroke(){
    set(HIGHLIGHT_COLOR, new Color(0, 0, 0));
    set(HIGHLIGHT_STROKE_WIDTH, 0d);
  }
  ...
  public boolean contains(Point2D.Double p) {
    double tolerance = Math.max(6f, AttributeKeys.getStrokeTotalWidth(this) / 2d);
