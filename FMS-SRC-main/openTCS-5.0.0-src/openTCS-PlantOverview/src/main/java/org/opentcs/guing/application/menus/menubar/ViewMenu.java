...
public class ViewMenu
  ...
  public ViewMenu(ViewActionMap actionMap,
                  OpenTCSView view,
                  ViewPluginPanelsMenu menuPluginPanels, ViewReport report, ViewVehicleStatisticReport vehicleStatisticReport) {
...
//    add(menuOrderSequenceView);
    ...
    //Menu item Report -> Report
//    add(report);

    add(vehicleStatisticReport);
