...
import org.opentcs.guing.application.action.view.*;
...
public class ViewActionMap
   ...
   * @param disableAllVehiclesAction The action to pause all vehicles
   ...
   * @param operatingAction The action to switch to operating mode.
  ...
  public ViewActionMap(OpenTCSView view,
                       ...
                       EnableAllVehiclesAction moveAllVehiclesAction,
                       DisableAllVehiclesAction disableAllVehiclesAction,
                       CreateGroupAction createGroupAction,
                       AboutAction aboutAction,
                       SwitchToModellingAction modellingAction,
                       SwitchToOperatingAction operatingAction,
                       ModelPropertiesAction modelPropertiesAction,
                       LoadModelFromKernelAction loadModelFromKernelAction,
                       VehicleRoutesAction vehicleRoutesAction,
                       VehicleStatisticsAction vehicleStatisticsAction,
                       CreateVehicleInOperatingAction createVehicleInOperatingAction) {
    ...
    requireNonNull(disableAllVehiclesAction, "pauseAllVehiclesAction");
    ...
    requireNonNull(operatingAction, "operatingAction");
    ...
    put(SwitchToOperatingAction.ID, operatingAction);
    ...
    put(CreateVehicleInOperatingAction.ID, createVehicleInOperatingAction);
    ...
    put(EnableAllVehiclesAction.ID, moveAllVehiclesAction);
    put(DisableAllVehiclesAction.ID, disableAllVehiclesAction);
    put(CreateGroupAction.ID, createGroupAction);
    put(VehicleRoutesAction.ID, vehicleRoutesAction);

    put(ReportAction.ID, new ReportAction(view));
    put(VehicleStatisticsAction.ID, vehicleStatisticsAction);

    // --- Menu Help ---
    put(OpenConfigurationTableAction.ID, new OpenConfigurationTableAction(view));
