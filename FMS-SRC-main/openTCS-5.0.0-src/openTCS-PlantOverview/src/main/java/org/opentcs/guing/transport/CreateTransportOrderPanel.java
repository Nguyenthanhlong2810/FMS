...
public class CreateTransportOrderPanel
  ...
  private void initCheckLoopEvent() {
    vehicleComboBox.addItemListener(e -> {
      loopTO.setSelected(false);
    });

    loopTO.addItemListener(e -> {
      if (e.getStateChange() == ItemEvent.SELECTED) {
        if (vehicleComboBox.getSelectedItem().toString().equalsIgnoreCase("Automatic")) {
          JOptionPane.showMessageDialog(null, "Please choose vehicle before check to loop");
          loopTO.setSelected(false);
        }
      }
    });
  ...
  public boolean isLoopTO() {
    return loopTO.isSelected();
  }
  ...
  private void initComponents() {
    ...
    loopTO = new javax.swing.JCheckBox();
    ...
    loopTO.setText("Loop transport order");
    vehiclePanel.add(loopTO, new java.awt.GridBagConstraints());
  ...
  private javax.swing.JCheckBox loopTO;
