...
import org.opentcs.guing.application.action.edit.*;
...
public class LabeledPointFigure
  ...
  public LabeledPointFigure(@Assisted PointFigure figure,
    ...
    set(AttributeKeys.STROKE_PLACEMENT, AttributeKeys.StrokePlacement.OUTSIDE);
  }
...
//    return closest;
  ...
  public Collection<Action> getActions(Point2D.Double p) {
    ...
    editOptions.add(new DeleteAction());
    return editOptions;
  }
