...
public class PointAdapter
  ...
  public void updateModelProperties(TCSObject<?> tcsObject,
    ...
    model.getLeftPoint().setValue(point.getLeftPoint());
    model.getRightPoint().setValue(point.getRightPoint());
        ...
        .withPoint(
            new PointCreationTO(modelComponent.getName())
                ...
                .withProperties(getKernelProperties(modelComponent))
                    .withLeftPoint(getKernelLeftPoint((PointModel) modelComponent))
                    .withRightPoint(getKernelRightPoint((PointModel) modelComponent))
        )
  ...
  private String getKernelLeftPoint(PointModel model) {
    return model.getLeftPoint().toString();
  }

  private String getKernelRightPoint(PointModel model) {
    return model.getRightPoint().toString();
  }
