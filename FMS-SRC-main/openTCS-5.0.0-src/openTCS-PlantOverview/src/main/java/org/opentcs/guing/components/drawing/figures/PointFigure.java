...
public class PointFigure
   ...
   */
  private static final Color C_HALT = new Color(215, 215, 215);

  private static final Color STROKE_COLOR = new Color(0, 136, 255);

  private static final Color STROKE_DIRECTION_COLOR = new Color(255, 42, 73);
  /**
  ...
  protected void drawStroke(Graphics2D g) {
    ...
    if (!getModel().getLeftPoint().getValue().equals("") || !getModel().getRightPoint().getValue().equals("")) {
      g.setColor(STROKE_DIRECTION_COLOR);
