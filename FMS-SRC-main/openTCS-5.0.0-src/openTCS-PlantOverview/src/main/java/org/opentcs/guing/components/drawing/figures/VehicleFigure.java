...
public class VehicleFigure
  ...
  public void setfImage(Image fImage) {
    this.fImage = fImage;
  }
...
//        SimpleFolder folder = (SimpleFolder) model.getActualParent();
  ...
  protected void drawFigure(Graphics2D g2d) {
    ...
    if (!model.getPropertyState().getValue().equals(Vehicle.State.UNKNOWN)
      && (currentPoint != null || precisePosition != null)) {
      drawFill(g2d);
    }
  }
