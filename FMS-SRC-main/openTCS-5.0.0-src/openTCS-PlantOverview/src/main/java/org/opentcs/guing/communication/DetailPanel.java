...
import static org.opentcs.guing.util.I18nPlantOverview.BUNDLE_PATH;
...
public class DetailPanel
   ...
   */
  @Inject
  public DetailPanel(@Assisted KernelServicePortal servicePortal,
                     @Assisted LocalVehicleEntry vehicleEntry,
    ...
    this.vehicleEntry = requireNonNull(vehicleEntry, "vehicleEntry");
  ...
  public void initialize() {
    ...
    for (VehicleCommAdapterPanelFactory factory : panelFactories) {
      factory.initialize();
    }
   ...
   */
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle(BUNDLE_PATH); // NOI18N
