...
public class DrawingViewScrollPane
  ...
  public DrawingViewScrollPane(OpenTCSDrawingView drawingView,
    ...
    setHorizontalScrollBar(new PlacardScrollbar(Adjustable.HORIZONTAL));
    setVerticalScrollBar(new PlacardScrollbar(Adjustable.VERTICAL));
  ...
  private class PlacardScrollbar
     ...
     public PlacardScrollbar(int orientation) {
      super(orientation);
      if (orientation == HORIZONTAL) {
        setPreferredSize(new Dimension(100, 22));
      } else {
        setPreferredSize(new Dimension(22, 100));
      }
