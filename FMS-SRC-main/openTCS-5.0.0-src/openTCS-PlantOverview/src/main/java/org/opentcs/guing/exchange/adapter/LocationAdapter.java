...
public class LocationAdapter
  ...
  public void updateModelProperties(TCSObject<?> tcsObject,
    ...
    try {
      ...
      model.getWidthProperty().setValueAndUnit(location.getWidth(), LengthProperty.Unit.MM);

      model.getHeightProperty().setValueAndUnit(location.getHeight(), LengthProperty.Unit.MM);
    ...
    PlantModelCreationTO result = plantModel
        .withLocation(
            new LocationCreationTO(modelComponent.getName(),
                ...
                .withWidth(((Double) ((LocationModel) modelComponent).getWidthProperty().getValue()).longValue())
                .widthHeight(((Double) ((LocationModel) modelComponent).getHeightProperty().getValue()).longValue())
        )
