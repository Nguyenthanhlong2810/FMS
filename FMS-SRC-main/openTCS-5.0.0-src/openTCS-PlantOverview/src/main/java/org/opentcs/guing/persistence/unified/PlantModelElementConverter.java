...
public class PlantModelElementConverter {
  ...
  public PointModel importPoint(PointCreationTO pointTO, VisualLayoutCreationTO layoutTO) {
    ...
    if(!pointTO.getLeftPoint().equals("")) {
      model.getLeftPoint().setValue(pointTO.getLeftPoint());
    }

    if(!pointTO.getRightPoint().equals("")) {
      model.getRightPoint().setValue(pointTO.getRightPoint());
    }
  ...
  public VehicleModel importVehicle(VehicleCreationTO vehicleTO, VisualLayoutCreationTO layoutTO) {
    ...
    model.getPropertyTypeTheme().setText(vehicleTO.getTypeTheme());
...
//    );
  ...
  public LocationModel importLocation(LocationCreationTO locationTO,
    ...
    model.getWidthProperty().setValueAndUnit(locationTO.getWidth(), LengthProperty.Unit.MM);

    model.getHeightProperty().setValueAndUnit(locationTO.getHeight(), LengthProperty.Unit.MM);
  ...
  public GroupModel importGroup(GroupCreationTO groupTO, VisualLayoutCreationTO layoutTO) {
    ...
    model.getDescriptionRoute().setText(groupTO.getDescription());
    model.getIdWorkingRoute().setValue(groupTO.getId());
    ...
    model.getPropertyColor().setColor(
            extractLayoutPropertyValue(layoutTO, groupTO.getName(), ElementPropKeys.WORKING_ROUTE_COLOR)
                    .map(colorName -> Color.decode(colorName))
                    .orElse(Color.red)
    );
