...
public class ViewManager
  ...
  private void setPlantOverviewStateModelling() {
    ...
    dockingManager.setDockableVisibility(DockingManager.VEHICLE_STATE_TABLE_ID, false);
  ...
  private void setPlantOverviewStateOperating() {
    ...
    dockingManager.setDockableVisibility(DockingManager.VEHICLE_STATE_TABLE_ID, true);
  }
